<script lang="ts">
	// PARC's static texture for print and social: single cells in the brand colors on
	// club green, generated from a grid, a density and a seed (the pixelkit recipe).
