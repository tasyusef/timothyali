...
<Seo
	...
	jsonLd={{
		...
		url: `${SITE_URL}/work/pocketwatch`,
		image: imageUrl('/images/pocketwatch/hero.png', SITE_URL)
	}}
/>
...
>
	...
	<TextSection title="Live">
		...
		<a
			...
			class="label-swiss hover-swiss mt-4 inline-block underline underline-offset-4"
		>
