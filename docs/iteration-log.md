...
The gap the three reviews all pointed at, between “the team was worried” and “the comments were encouraging”, now has its middle. Timothy sent the direction the team turned down: three branch lockups, The Nightclub, The Parcade and The Rowboat Club, black pixel wordmarks with a red icon each. The PARC study shows the sheet under “An earlier direction”, dated around 2024 on his correction, with one paragraph in his account, before the shipped logo. Rendered from his SVG through the site's Chromium onto white, 1600×1000 plus a 2× JPEG, noted “Set aside, 2026”. Awaiting his eye on the preview.

## PX-46 — One PARC study (2026-09-22, 0126)

Timothy asked for the PARC brand and PARC Website studies to be one. The brand study keeps its arc and gains the website as a second act, in the website study's own words, with about half of its screenshots; the brand study's duplicate site shots go. One reaction list and one outcome list close it. The old URL redirects. The share-image generator now takes `OG_PORT` from the environment, because 4174 was Timothy's own preview and 4175 Codex's. Check, build and the 17-page metadata verification pass. Awaiting his eye on the preview.
