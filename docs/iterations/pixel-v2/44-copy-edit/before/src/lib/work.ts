...
const source: Source[] = [
  ...
  },
  {
    ...
    lead: [
      "Jade Aesthetics is a medical spa in Wheaton, Illinois. I designed its first website in Framer, then rebuilt it in Next.js when the practice needed a page for each treatment: the visual style, page design, and development of both versions."
    ],
