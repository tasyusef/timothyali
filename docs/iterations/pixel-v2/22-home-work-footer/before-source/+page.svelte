...
<main id="main" tabindex="-1">
  ...
  <section class="work-index" aria-labelledby="work-title">
    ...
    <div class="work-foot"><a class="lbl" href="/work/">All work <Arrow /></a></div>
  </section>
...
.work-foot a{display:inline-flex;align-items:center;gap:var(--s2);padding:var(--s1) 0}
...
.invitation h2{display:flex;flex-direction:column;gap:var(--s2);padding-bottom:var(--s8)}
...
@media(max-width:700px){
  ...
  .work-statement{line-height:48px}.work-statement .blackletter{font-size:43px}
