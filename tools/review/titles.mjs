...
for(const width of [1440,1100,900,390,375,320]){for(const slug of ['parc','xrpcafe','firstledger','do-androids-dream','firststrike','sonde','jade-aesthetics','pocketwatch']){
